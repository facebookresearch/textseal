...
"""
Run with:
    python -m apps.common.llm.generate --ckpt /path/to/checkpoint/consolidated

    python -m apps.common.llm.generate --ckpt /path/to/checkpoint/consolidated --prompts "Hello, " "How are" --temperature 0.9 --top_p 0.95
